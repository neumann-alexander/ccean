...
class ZVI_Reader implements PlugIn {
    boolean littleEndian = true;
    protected int theC, theZ, numC;
//+ (mb)    
    //+ new code
    protected Set C_Set = new HashSet(); // to hold C channel index collection
//- (mb)    
  ...
  protected static final byte[] ZVI_SIG = {
    -48, -49, 17, -32, -95, -79, 26, -31
  };

  /** Block identifying start of useful header information. */
  protected static final byte[] ZVI_MAGIC_BLOCK_1 = { // 41 00 10
    65, 0, 16
  };

  /** Block identifying second part of useful header information. */
  protected static final byte[] ZVI_MAGIC_BLOCK_2 = { // 41 00 80
    65, 0, -128
  };

  /** Block identifying third part of useful header information. */
  protected static final byte[] ZVI_MAGIC_BLOCK_3 = { // 20 00 10
    32, 0, 16
  };
...
//if (arg.equals("")) show();
  ...
  protected FileInfo[] getHeaderInfo(String directory, String fileName)
    throws IOException
  {
...
//- (mb)
   ...
   */
  protected long findBlock(RandomAccessFile in, byte[] block, long start)
    throws IOException
  {
    long filePos = start;
  ...
  protected static int batoi(byte[] b) {
  ...
  protected static int readInt(RandomAccessFile fin) throws IOException {
    byte[] b = new byte[4];
    fin.readFully(b);
    return batoi(b);
  }
...
//+ (mb)
  ...
  protected static int getChannel(FileInfo theFi) {
...
//- (mb)
  ...
  protected class ZVIBlock {
    protected int theZ, theC, theT;
    protected int width, height;
    protected int alwaysOne;
    protected int bytesPerPixel;
    protected int pixelType;
    protected int bitDepth;
    protected long imagePos;

    protected int numPixels;
    protected int imageSize;
    protected int numChannels;
    protected int bytesPerChannel;
